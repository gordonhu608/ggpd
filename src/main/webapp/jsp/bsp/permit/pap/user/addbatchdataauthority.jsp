...
<script type="text/javascript" src="<l:asset path='bsp/user/addbatchuserdataauthority.js'/>"></script>
</head>
<body>
		...
		<div class="container">
			<form class="form-inline" onsubmit="return false">	
				<div class="btn-group">
					...
					<input type="text" class="form-control ue-form" id="bachtOrganName" placeholder="<spring:message code="bsp.user.090" text="请输入组织名称"></spring:message>"/>											
					<div class="input-group-addon ue-form-btn" id="addBatchDataQuery" >
						<span class="fa fa-search"></span>
				    </div>
				</div>
			</form>
			<table id="AddBatchDatasAutList" class="table table-bordered table-hover">
				<thead>
					<tr>
						...
						<th width="20%" data-field="organName" data-render="permitPerations"><spring:message code="bsp.user.009" text="操作"></spring:message></th>
					</tr>
				</thead>
			</table>
		</div>
