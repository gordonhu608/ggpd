...
<link rel="stylesheet" type="text/css" href="<l:asset path='bsp/css/audit/auditlog.css'/>" />
...
<script type="text/javascript" src="<l:asset path='bsp/audit/auditlog.js'/>"></script>
	...
	<div class="container">
		<form class="form-inline" onsubmit="return false;">
			...
			<div class="btn-group pull-right">
				<button id="details" type="button" class="btn ue-btn">
					<span class="fa fa-file"></span><spring:message code="bsp.auditlog.007" text="明细"/>
				</button>
			</div>
		</form>
		<table id="auditlogList" class="table table-bordered table-hover">
			<thead>
				<tr>
					...
					<th width="31%" data-field="requestActionName"
						data-render="requestActionNameAndPath"><spring:message code="bsp.auditlog.010" text="操作日志"/></th>
