...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<l:asset path='bsp/css/role/roleauthrizenoorg.css'/>"/>
  <!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
	...
	<script  type="text/javascript" src="<l:asset path='bsp/role/roleauthrizenoorg.js'/>"></script>
