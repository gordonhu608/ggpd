$(function() {
	...
	$("#reset").bind("click", function() {
		window.location.href = context + "/service/bsp/userinfonoorg";
...
function Validnewpassword(gets, obj, curform, regxp) {
	...
	var url = context + "/service/bsp/userinfonoorg/oldpassword";
	$.ajax({
		type : "post",
		url : url,
		async : false,
	...
	var url = context + "/service/bsp/userinfonoorg/checknewpassword";
	$.ajax({
		type : "post",
		url : url,
		async : false,
...
function saveBtn() {
	...
	var newpassWord = $("#newpassWord").val();
	var url = context + "/service/bsp/userinfonoorg/newpassword";
	$.ajax({
		type : "post",
		url : url,
		async : false,
...
function encodePwd(rawPassword) {
	...
	// 获取公钥
	$.ajax({
		url: context + "/service/bsp/userinfonoorg/pubKey",
		async: false,
		type: "get",
