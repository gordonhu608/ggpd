 ...
 * 类名:     InspurComboPooledDataSource
 * 描述:      修改了 com.mchange.v2.c3p0.ComboPooledDataSource 包中相关代码，
 *            在datasource.xml作为数据库连接池使用
 * 创建人:    tangxianwei   
 * 创建时间:  2020/8/3 10:45  
 * 修改人:    tangxianwei  
 * 修改时间:  2020/8/3 10:45  
 ...
 *  
 */
public final class InspurComboPooledDataSource extends AbstractPoolBackedDataSource implements PooledDataSource, Serializable, Referenceable {
    static final MLogger logger;
    static final Set TO_STRING_IGNORE_PROPS;
    transient InspurDriverManagerDataSource dmds;
    transient WrapperConnectionPoolDataSource wcpds;
    private static final long serialVersionUID = 1L;
    private static final short VERSION = 1;

    public InspurComboPooledDataSource() {
        this(true);
    }

    public InspurComboPooledDataSource(boolean autoregister) {
        super(autoregister);
        this.dmds = new InspurDriverManagerDataSource();
    ...
    private void setUpPropertyEvents() {
            ...
            public void vetoableChange(PropertyChangeEvent evt) throws PropertyVetoException {
                ...
                if ("connectionPoolDataSource".equals(propName)) {
                    if (!(val instanceof WrapperConnectionPoolDataSource)) {
                        throw new PropertyVetoException("InspurComboPooledDataSource requires that its ConnectionPoolDataSource  be set at all times, and that it be a com.mchange.v2.c3p0.WrapperConnectionPoolDataSource. Bad: " + val, evt);
                    }

                    DataSource nested = ((WrapperConnectionPoolDataSource)val).getNestedDataSource();
                    if (!(nested instanceof DriverManagerDataSource)) {
                        throw new PropertyVetoException("InspurComboPooledDataSource requires that its unpooled DataSource  be set at all times, and that it be a com.mchange.v2.c3p0.DriverManagerDataSource. Bad: " + nested, evt);
                    }
                }
        ...
        PropertyChangeListener wcpdsStateUpdater = new PropertyChangeListener() {
            ...
            public void propertyChange(PropertyChangeEvent evt) {
                com.inspur.ggpd.data.source.InspurComboPooledDataSource.this.updateLocalVarsFromCpdsProp();
            }
        };
    ...
    private void updateLocalVarsFromCpdsProp() {
        ...
        this.dmds = (InspurDriverManagerDataSource)this.wcpds.getNestedDataSource();
    }

    public InspurComboPooledDataSource(String configName) {
        this();
