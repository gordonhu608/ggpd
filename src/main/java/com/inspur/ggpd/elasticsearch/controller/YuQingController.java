...
public class YuQingController {
    ...
    String indexName = PropertiesUtil.getValueByKey("elasticsearch.quxing.index");// 后边改成配置的

    //
    String type = PropertiesUtil.getValueByKey("elasticsearch.quxing.type");
    ;
    String titleField = "BTM";
    String contentField = "HXNR";
    // 定义返回字段
    String[] fields = {"BTM", "FBSJ", "ID", "LY"};
    ...
    private long getTotalSearch(Map<String, Object> paramMap) {
        ...
        try {
            // 6.x版本有 searchRequest.types，7.x版本没有
