...
<script type="text/javascript" src="<l:asset path='bsp/userinfo/passwordstrengthnoorg.js'/>"></script>
<script type="text/javascript" src="<l:asset path='bsp/userinfo/userinfomodifynoorg.js'/>"></script>
