...
--BSP v7.0之后修改为nullable 20161227
ALTER TABLE PUB_USER_EMPLOYEE MODIFY (CORPORATION_ID NULL);
ALTER TABLE PUB_USER_EMPLOYEE MODIFY (DEPARTMENT_ID NULL);
...
CREATE INDEX IDX_PUD_CODE ON PUB_USER_DATA(CODE);
...
(
	THEME_ID   VARCHAR2(30) NOT NULL,
	THEME_URL  VARCHAR2(50),
	ICON       VARCHAR2(100)
);
...
(
	...
	REMIDER_INTERVAL   NUMBER(8),
	REMIDER_TIME_UNIT  VARCHAR2(4)
);
...
(
	...
	UPDT_TIME  VARCHAR2(17) NOT NULL
);
